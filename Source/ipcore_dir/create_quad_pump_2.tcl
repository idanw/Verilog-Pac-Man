...
set result [ run_cg_create "xilinx.com:ip:dcmca:13.1" "quad_pump_2" "Cascading in Series with Two DCMs" "Cascading in Series with Two DCMs (xilinx.com:ip:dcmca:13.1) generated by Project Navigator" xc3s200-5ft256 Verilog ]
